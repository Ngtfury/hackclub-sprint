    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "var(--brand-red)", color: "var(--brand-red)" },
          complete: { scale: 1, backgroundColor: "var(--brand-red)", color: "var(--brand-red)" },
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "var(--brand-red)" },
  }
